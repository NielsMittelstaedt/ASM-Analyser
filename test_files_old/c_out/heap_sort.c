...
void swap()
{
    ...
    store_counter ++;
    str(&ip.i, &r0.i, ((uint32_t)r1.i << 2), 4, false, false, false);
    store_counter ++;
    str(&r3.i, &r0.i, ((uint32_t)r2.i << 2), 4, false, false, false);
    return;
...
L12:
    counters[2] ++;
    load_counter ++;
    ldr(&r4.i, &r0.i, ((uint32_t)lr.i << 2), 4, false, false, false);
    load_counter ++;
    ldr(&r5.i, &r0.i, ((uint32_t)r2.i << 2), 4, false, false, false);
    tmp = r5.i - r4.i;
    z = tmp == 0;
    n = tmp & 0x80000000;
...
L13:
    counters[6] ++;
    load_counter ++;
    ldr(&r4.i, &r0.i, ((uint32_t)r2.i << 2), 4, false, false, false);
    load_counter ++;
    ldr(&lr.i, &r0.i, ((uint32_t)ip.i << 2), 4, false, false, false);
    store_counter ++;
    str(&r4.i, &r0.i, ((uint32_t)ip.i << 2), 4, false, false, false);
    store_counter ++;
    str(&lr.i, &r0.i, ((uint32_t)r2.i << 2), 4, false, false, false);
    r2.i = r3.i;
L7:
    counters[7] ++;
...
L11:
    counters[10] ++;
    load_counter ++;
    ldr(&r5.i, &r0.i, ((uint32_t)r3.i << 2), 4, false, false, false);
    tmp = r4.i - r5.i;
    z = tmp == 0;
    n = tmp & 0x80000000;
...
L18:
    counters[17] ++;
    load_counter ++;
    ldr(&ip.i, &r4.i, -4, 4, true, false, false);
    r1.i = r5.i;
    load_counter ++;
    ...
    r5.i = r5.i - (1);
    store_counter ++;
    str(&ip.i, &r0.i, 0, 4, false, false, false);
    store_counter ++;
