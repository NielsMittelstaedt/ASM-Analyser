...
void main()
{
    ...
    if (!z && n == v)
    {
        str(&r0.i, &sp.i, 8, 4, false, false, false);
    }
L5:
    counters[1] ++;
    load_counter ++;
...
L14:
    counters[9] ++;
    load_counter ++;
    ldr(&ip.i, &sp.i, 20, 4, false, false, false);
    tmp = r0.i - ip.i;
    z = tmp == 0;
    n = tmp & 0x80000000;
    ...
    if (!z && n == v)
    {
        str(&ip.i, &sp.i, 16, 4, false, false, false);
    }
L13:
    counters[10] ++;
    tmp = r2.i - r0.i;
...
L11:
    ...
    sp.i += 4;
    str(&ip.i, &sp.i, 0, 4, false, false, false);
    sp.i = tmp;
    r3.i = ip.i;
    goto L14;
    return;
