...
void main()
{
    ...
    store_counter ++;
    tmp = r6.i;
    str(&r0.i, &r6.i, 0, 4, false, false, false);
    r6.i += 4;
    str(&r1.i, &r6.i, 0, 4, false, false, false);
    r6.i += 4;
    str(&r2.i, &r6.i, 0, 4, false, false, false);
    r6.i += 4;
    str(&r3.i, &r6.i, 0, 4, false, false, false);
    r6.i += 4;
    r6.i = tmp;
    load_counter ++;
    tmp = lr.i;
    ...
    store_counter ++;
    tmp = r7.i;
    str(&r0.i, &r7.i, 0, 4, false, false, false);
    r7.i += 4;
    str(&r1.i, &r7.i, 0, 4, false, false, false);
    r7.i += 4;
    str(&r2.i, &r7.i, 0, 4, false, false, false);
    r7.i += 4;
    str(&r3.i, &r7.i, 0, 4, false, false, false);
    r7.i += 4;
    r7.i = tmp;
    load_counter ++;
    ldr(&r0.i, &r5.i, 0, 4, false, false, false);
    r5.i += 4;
    ldr(&r1.i, &r5.i, 0, 4, false, false, false);
    r5.i += 4;
    ldr(&r2.i, &r5.i, 0, 4, false, false, false);
    r5.i += 4;
    ldr(&r3.i, &r5.i, 0, 4, false, false, false);
    r5.i += 4;
    store_counter ++;
    str(&r0.i, &r4.i, 0, 4, false, false, false);
    r4.i += 4;
    str(&r1.i, &r4.i, 0, 4, false, false, false);
    r4.i += 4;
    str(&r2.i, &r4.i, 0, 4, false, false, false);
    r4.i += 4;
