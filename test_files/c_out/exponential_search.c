...
reg r1, r5, r0, r6, r8, r9, r3, r4, r2;

int32_t LC3, LC4, LC5, LC6, LC7, LC8, LC9, LC10, LC0, __PRETTY_FUNCTION__4935, LC2;

int counters[60] = { 0 };
int load_counter = 0, store_counter = 0;
int block_sizes[60] = {2,3,3,10,1,5,1,7,2,7,1,2,2,2,2,3,3,10,1,5,1,7,2,7,1,2,2,1,6,1,5,1,7,2,7,1,2,2,11,2,5,2,7,2,5,2,10,2,10,2,10,2,3,7,7,7,7,7,7,7};

int exponential_searchpart;
...
L27:
        ...
        return;
        counters[27] ++;
        goto exponential_searchpart0;
    }
    if (exponential_searchpart == 0)
    {
