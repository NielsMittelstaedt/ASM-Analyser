...
class BasicBlock:
    '''Represents a code section that corresponds to a basic block.
    ...
    def get_return_type(self) -> str:
        '''If the block is a function, this method determines the return type.
        ...
        return self._get_var_type_rev(reg_to_search)

    def _get_var_type_rev(self, register: str) -> str:
        '''Determines the type of a variable/register.

        Determines the type of the given variable by iterating backwards
        through the instructions of this block.
    ...
    def _get_var_type(self, search_idx: int, register: str) -> str:
        ...
        by iterating through the instructions of this block.
